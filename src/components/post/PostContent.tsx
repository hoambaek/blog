  ...
  return (
    <article>
      ...
      <div className="container-narrow px-5 sm:px-6 py-10 sm:py-12 md:py-16">
        {/* Article Content */}
        <div
          className="prose prose-stone max-w-none mx-auto post-content
            prose-headings:font-display prose-headings:font-normal prose-headings:tracking-tight
            prose-h2:text-lg prose-h2:sm:text-xl prose-h2:md:text-2xl prose-h2:mt-10 prose-h2:sm:mt-14 prose-h2:md:mt-16 prose-h2:mb-5 prose-h2:sm:mb-6 prose-h2:md:mb-8
            ...
            prose-p:text-[15px] prose-p:sm:text-base prose-p:md:text-lg prose-p:leading-[1.85] prose-p:sm:leading-[1.9] prose-p:mb-5 prose-p:sm:mb-6 prose-p:md:mb-8 prose-p:text-muted-foreground
