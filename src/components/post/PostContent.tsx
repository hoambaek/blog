      ...
      <div className="container-narrow px-5 sm:px-6 py-8 sm:py-10 md:py-12">
        ...
        <div
          className="prose prose-stone mx-auto post-content
            ...
            prose-p:text-[15px] prose-p:sm:text-base prose-p:md:text-lg prose-p:leading-[1.85] prose-p:sm:leading-[1.9] prose-p:mb-5 prose-p:sm:mb-6 prose-p:md:mb-8 prose-p:text-muted-foreground prose-p:text-justify prose-p:md:text-left
