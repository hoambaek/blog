...
### 2단계 — 브랜드 방향 기반 작성
- 분석 결과를 바탕으로 브랜드 톤(조용하고 절제된 럭셔리. 시적 수사보다 담백한 서술)으로 작성한다.
- 정직한 분업(샹파뉴가 만들고, 바다가 기록한다) · "바다가 정한다"(수량·시간·출시) · 측정=헌신 프레임을 반영한다.
- **문장 스타일은 `docs/content/writing-style.md`를 반드시 먼저 읽고 따른다** (제목의 질문에 곧장 답하기 · 경구·잠언형 꾸민 문장 금지 · 정제하되 무겁지 않은 어휘 · 평서문 소제목). 대표가 피드백으로 맞춘 기준이다.
